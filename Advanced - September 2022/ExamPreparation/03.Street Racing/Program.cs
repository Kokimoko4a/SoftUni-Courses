...
namespace StreetRacing
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            //Initialize Race
            Race race = new Race("RockPort Race", "Sprint", 1, 4, 200);
           ...
           Car carOne = new Car("BMW", "320cd", "NFS2007", 150, 1350);
            Car carTwo = new Car("Audi", "A3", "NFS2004", 170, 1300);
            Car s = new Car("Audi", "A3", "NFSd004", 120, 1300);
            Car carTwgo = new Car("Audi", "A3", "NFSd604", 10, 1300);
